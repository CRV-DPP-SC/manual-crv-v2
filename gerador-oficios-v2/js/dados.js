...
const UNS = [
  ...
  {n:'Presídio Regional de Tijucas',c:'Tijucas',sr:'SR01',dir:'Joana Mahfuz Vicini',cg:'Diretora',em:'pr03@pp.sc.gov.br',tel:'(48) 3665-9280',e:'Rua Alberto Tomazi, s/n — Itinga — Tijucas/SC — CEP 88200-000'},
  ...
  {n:'Presídio Masculino Regional de Florianópolis',c:'Florianópolis',sr:'SR01',dir:'Elison Ivan Soares',cg:'Diretora',em:'pr01@pp.sc.gov.br',tel:'(48) 3665-9256',e:'Rua Delminda da Silveira, 900 — Agronômica — Florianópolis/SC — CEP 88025-500'},
  ...
  {n:'Colônia Agroindustrial de Palhoça',c:'Palhoça',sr:'SR01',dir:'Rodrigo Alves Teixeira',cg:'Diretora',em:'cogri@pp.sc.gov.br',tel:'(48) 3664-5580',e:'Rua José João Barcelos, s/n — Bela Vista — Palhoça/SC — CEP 88132-770'},
  /* SR02 — Sul */
  ...
  {n:'Penitenciária Industrial de Joinville',c:'Joinville',sr:'SR03',dir:'Juliano Cesar Camargo',cg:'Diretor',em:'pe06@pp.sc.gov.br',tel:'(47) 3481-3948',e:'Servidão Antônio Deglmann Júnior, 245 — Parque Guarani — Joinville/SC — CEP 89209-240'},
  {n:'Presídio Feminino Regional de Joinville',c:'Joinville',sr:'SR03',dir:'Léia Cristina Steffen Fuck',cg:'Diretora',em:'pr12@pp.sc.gov.br',tel:'(47) 3481-2369',e:'Servidão Antônio Deglmann Júnior, 245 — Parque Guarani — Joinville/SC — CEP 89209-240'},
  ...
  {n:'Presídio Regional de Barra Velha',c:'Barra Velha',sr:'SR03',dir:'Nathasha Daberkow Vieira',cg:'Diretora',em:'pr14@pp.sc.gov.br',tel:'(47) 3481-2885',e:'Rua João Anselmo Breniensen, s/n — Vila Nova — Barra Velha/SC — CEP 88390-000'},
  ...
  /* SR05 — Serrana */
  {n:'Penitenciária Industrial de São Cristóvão do Sul',c:'São Cristóvão do Sul',sr:'SR05',dir:'Mario Machado Rosa',cg:'Diretora',em:'pe09@pp.sc.gov.br',tel:'(49) 3412-3190',e:'Estrada Geral Paredão, s/n — São Cristóvão do Sul/SC — CEP 89533-000'},
  {n:'Penitenciária Regional de Curitibanos',c:'São Cristóvão do Sul',sr:'SR05',dir:'Sinara Ortiz dos Santos',cg:'Diretor',em:'pe08@pp.sc.gov.br',tel:'(49) 3412-3300',e:'Rua Juventino França de Moraes, s/n — São Cristóvão do Sul/SC — CEP 89533-000'},
  ...
  {n:'Presídio Regional de Joaçaba',c:'Joaçaba',sr:'SR06',dir:'Silvio André Gutz',cg:'Diretora',em:'pr27@pp.sc.gov.br',tel:'(49) 3527-9829',e:'BR-282, km 391 — Vila Remor — Joaçaba/SC — CEP 89600-000'},
  {n:'Presídio Regional de Maravilha',c:'Maravilha',sr:'SR06',dir:'Marcos Borgaro',cg:'Diretor',em:'pr29@pp.sc.gov.br',tel:'(49) 3664-6672',e:'Av. Sul Brasil, 1607 — Centro — Maravilha/SC — CEP 89874-000'},
  ...
  {n:'Presídio Regional de São Miguel do Oeste',c:'São Miguel do Oeste',sr:'SR06',dir:'João Batista Lopes',cg:'Diretor',em:'pr31@pp.sc.gov.br',tel:'(49) 3631-3754',e:'Rua Oiapoc, 1795 — Centro — São Miguel do Oeste/SC — CEP 89900-000'},
  ...
  /* SR08 — Planalto Norte */
  {n:'Penitenciária Industrial de São Bento do Sul',c:'São Bento do Sul',sr:'SR08',dir:'Fabio José Kolb',cg:'Diretor',em:'pe13@pp.sc.gov.br',tel:'(47) 3647-0240',e:'Rua Miguel Hubl, 400 — Lençol — São Bento do Sul/SC — CEP 89289-580'},
