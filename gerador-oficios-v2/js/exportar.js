...
function getCSS() {
  return [
    /* @page: margens que acomodam cab/rod fixos */
    '@page{size:A4;margin:2.8cm 2cm 2.5cm 3cm}',
    '@media print{',
      ...
      '.ofc-cab{position:fixed;top:0;left:0;right:0;padding:0.35cm 2cm 0.2cm 3cm;background:#fff;z-index:100}',
      '.ofc-cab img{height:38pt!important}',
    ...
    '#oficio{background:#fff;max-width:21cm;margin:0 auto;display:flex;flex-direction:column;min-height:27cm;padding:1cm 1.5cm 0 1.5cm}',
    ...
    '.ofc-cab img{height:46pt;flex-shrink:0}',
    ...
    '.ofc-dest-wrap{margin-top:auto;padding-top:18pt}',
