...
function getCSS() {
  return [
    ...
    '.ofc-rodape{padding:0 0 10px;font-family:Arial,sans-serif}',
    '.rod-linha{border-top:0.5pt solid #555;margin-bottom:5px}',
    '.rod-info{text-align:center;font-size:8.5pt;color:#222;line-height:1.5}',
    '.rod-dpp{font-weight:bold;font-size:9pt;text-transform:uppercase;display:block;letter-spacing:.03em}',
    '.rod-end{font-weight:normal;font-size:8pt;display:block;color:#333}',
    '.rod-cont{font-size:8pt;display:block;color:#333}',
    '.anexo-inner{font-family:Arial,sans-serif}',
